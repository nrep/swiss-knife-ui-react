            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                        ...
                        <a href="#" className="font-medium text-gray-500 hover:text-gray-900 ml-8">Features</a>

                        <a href="#" className="font-medium text-gray-500 hover:text-gray-900 ml-8">Marketplace</a>

                        <a href="#" className="font-medium text-gray-500 hover:text-gray-900 ml-8">Company</a>

                        <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500 ml-8">Log in</a>
                    </div>
                    </nav>
                </div>
